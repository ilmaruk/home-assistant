...
from homeassistant.components.sensor.sensehat import SenseHatSensor,\
    _get_temperature_average, _normalise_current_temperature,\
    _get_cpu_temperature, _update_readings_history
...
class TestSenseHat(unittest.TestCase):
    ...
    def test_get_current_temperature_average(self) -> None:
        self.assertEqual(
            _get_temperature_average([20, None, 21.2, None, 22.4]), 21.2)
